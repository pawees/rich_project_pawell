...
class NewsApiMock implements INewsApi {
  ...
  List<String> urls = [
    ...
    'https://the-flow.ru/uploads/images/resize/830x0/adaptiveResize/10/19/33/44/52/200a5b940cd7.jpg',
    'https://the-flow.ru/uploads/images/catalog/element/63d38ec17fef6.jpg',
    'https://the-flow.ru/uploads/images/catalog/element/63d3815946155.jpg',
    'https://the-flow.ru/uploads/images/resize/830x0/adaptiveResize/14/88/64/63/56/4b3b9ec40cd7.jpg',
    'https://the-flow.ru/uploads/images/resize/830x0/adaptiveResize/14/85/29/53/47/621a56840cd7.jpg',
    'https://the-flow.ru/uploads/images/resize/830x0/adaptiveResize/09/81/06/16/56/31b5bc540cd7.jpg',
    'https://the-flow.ru/uploads/images/resize/830x0/adaptiveResize/16/37/89/00/10/a49a9d840cd7.jpg',
  ...
  List<String> titles = ['ASAP Rocky выпустил трек "Same Problems?"',
    ...
    'Tenderlybae впервые показала лицо в новом клипе «Ломай»',
  ...
  List<String> texts = ['Сингл с альбома "Don’t Be Dumb", который все ждут в этом году.',
    ...
    'Больше не Волк(',
    '«Это что я теперь могу нос смайликом не закрывать?»,',
    'В этом году группе исполняется 10 лет.',
